...
$string['gateway_usage'] = 'Client usage';
$string['gateway_usage_desc'] = 'Current usage and limits from the Gateway (refreshed when you load this page).';
$string['gateway_usage_connection_error'] = 'Could not connect to usage endpoint.';
$string['gateway_usage_auth_error'] = 'Authentication failed. Check your Gateway token.';
$string['gateway_usage_http_error'] = 'Gateway returned HTTP {$a}.';
$string['gateway_usage_invalid_response'] = 'Invalid response from usage endpoint.';
$string['gateway_usage_not_configured'] = 'Set Gateway endpoint and token above, then save to see usage.';
$string['gateway_usage_requests'] = 'Requests';
$string['gateway_usage_limits'] = 'Limits';
$string['gateway_usage_remaining'] = 'Remaining';
$string['gateway_usage_total'] = 'Total';
$string['gateway_usage_today'] = 'Today';
$string['gateway_usage_week'] = 'This week';
$string['gateway_usage_month'] = 'This month';
$string['gateway_usage_year'] = 'This year';
...
$string['gateway_usage_client_name'] = 'Client';
