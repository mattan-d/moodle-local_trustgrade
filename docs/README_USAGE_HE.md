...
![המלצת AI – קריטריונים פדגוגיים](screenshots/05.png)
...
צילומי המסך במדריך זה ממוקמים בתיקייה `docs/screenshots/`.  
מיפוי שמות הקבצים (01.png, 02.png וכו') והתיאור של כל צילום מופיע בקובץ `docs/screenshots/README.txt`.
