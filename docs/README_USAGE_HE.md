...
> **צילומי מסך:** בכל מקום שמופיע "📷 צילום מסך (XX)" יש להציב את קובץ התמונה `XX.png` בתיקייה `docs/screenshots/`. אם הקבצים חסרים, המדריך עדיין קריא; הוסף צילומי מסך לפי המיפוי ב־`docs/screenshots/README.txt`.
...
1. **הוספת מטלה**  
   ...
   **📷 צילום מסך (01):** הוספת מטלה – חלון "Add an activity or resource" עם בחירת Assignment.
...
**📷 צילום מסך (03):** הגדרות TrustGrade – הפעלת הרכיב, הגדרות חידון, חלוקת שאלות, זמן לכל שאלה.
...
**📷 צילום מסך (04):** מאגר שאלות ובדיקת הנחיות – הנחיות לעריכה, קבצים, כפתור "בדוק הנחיות עם AI".
...
**📷 צילום מסך (05):** המלצת AI – טבלת קריטריונים פדגוגיים (קריטריון, הושג, הצעות).
...
**📷 צילום מסך (06):** הערכה והמטלה המשופרת – טקסט הערכה ומבנה המטלה המשופרת.
...
**📷 צילום מסך (08):** דף הסבר – "Creating quiz questions by uploading files" עם How does it work.
...
**📷 צילום מסך (07):** טופס "Create questions from files" – העלאת קבצים, מספר שאלות, הנחיות.

**📷 צילום מסך (10):** אזור גרירה, מספר שאלות 5, כפתור Generate questions.
