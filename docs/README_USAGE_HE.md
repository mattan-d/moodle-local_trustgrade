...
בעמוד המטלה, בעת **הוספת הגשה** או **עריכת הגשה**, מופיע מסך הגשת המטלה:

![תמונה 10: מסך הגשת המטלה ע״י הסטודנט](screenshots/10.png)

מופיע בלוק **AI-Enhanced Learning Experience**:

![עריכת הגשה – חוויית למידה מוגברת AI](screenshots/18.png)
