...
namespace local_trustgrade\hook;

defined('MOODLE_INTERNAL') || die();

/**
 * Hook callbacks for TrustGrade plugin
 */
final class callbacks {
    ...
    public static function after_form_definition(\core_course\hook\after_form_definition $hook): void {
        ...
        $formwrapper = $hook->get_formwrapper();
        $mform = $hook->get_mform();
        
        // Only apply to assignment forms
    ...
    /**
     * Hook called before standard HTML head generation
     * 
    ...
    /**
     * Hook called after course module form is submitted
     * 
